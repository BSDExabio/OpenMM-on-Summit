...
##
# Schedulers don't need GPUs. We give each 35 CPUs to handle the overhead of managing so many workers.
jsrun --smpiargs="off" --nrs 1 --rs_per_host 1 --tasks_per_rs 1 --cpu_per_rs 35 --gpu_per_rs 0 --latency_priority cpu-cpu --bind none \
